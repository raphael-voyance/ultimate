...
<head>
    ...
    <link rel="icon" type="image/vnd.icon" href="{{ asset(config('siteconfig.favicon', 'favicon.ico')) }}">
    ...
    <!-- Scripts -->
    @livewireStyles
    @vite(['resources/css/app.css', 'resources/js/app.js', 'resources/js/add/hero_home.js', 'resources/css/add/hero_home.css'])
...
<body class="min-h-screen font-serif antialiased">
    ...
    <x-structure.main-content class="bg-base-100" full-width>
        ...
        <x-slot:content>
            ...
            <!-- Début Page Content -->
            <div class="w-full max-w-6xl py-8 px-4 mx-auto bg-neutral text-neutral-100 rounded-md sm:px-6 lg:px-8">
                {{ $slot }}
            </div>
            <!-- Fin Page Content -->
