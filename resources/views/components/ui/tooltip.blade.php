<div
    x-data="{
        ...
        tooltipArrow: {{ $tooltipArrow ? 'true' : 'false' }},
    ...
    <div x-ref="content" class="px-3 py-1 text-xs rounded-full cursor-pointer text-neutral-500 bg-neutral-100">{{ $buttonText }}</div>
