...
class Input extends Component
{
    ...
    {
        //dump($this->attributes->whereStartsWith('name')->first());
                ...
                <div class="flex-1 relative">
                    ...
                    <input
                        ...
                        {{
                            ...
                            ->class([
                                'input input-primary w-full peer focus:border-none focus:ring-primary-focus',
                                'pl-10' => ($icon),
                                'h-14' => ($inline),
                                'pt-3' => ($inline && $label),
                    ...
                    <!-- ICON  -->
                    @if($icon)
                        <x-mary-icon :name="$icon" class="absolute top-1/2 -translate-y-1/2 left-3 text-gray-400 " />
                    @endif

                    <!-- RIGHT ICON  -->
                    @if($iconRight)
                        <x-mary-icon :name="$iconRight" class="absolute top-1/2 right-3 -translate-y-1/2 text-gray-400 " />
                    @endif
